...
import mainImage from '../public/blocks-T3mKJXfdims-unsplash.jpg'
import image3 from '../public/kevin-mccutcheon-TcSckNRL9J8-unsplash.jpg'
  ...
  <main className="bg-black p-16 text-white">
    <section className="max-w-5xl mx-auto px-8 border-x border-white">
      <article className="text-2xl pb-8">
        ...
        vinyle ? Trouve dans ta ville ou ton quartier les 33 tours qui manquent
        à ta collection.
      </article>
      <figure className="relative">
        <Image alt="Bibliothèque vinyle" src={mainImage} layout="responsive" />
        <Link href="/library">
      ...
      <figure className="pt-8 grid grid-cols-2">
        ...
        <article className="flex flex-col justify-evenly">
          ...
          <p className="py-4">
            ...
            Liste ici les vinyles que tu recherches (nom artiste ou titre album)
          </p>
        ...
        <ul>
          <li>
            <p className="py-4">
              ...
              Jim trouve chez Jason un disque qui l&apos;intéresse et Jason voit
              chez Jim le disque qu&apos;il recherche. Jim et Jason se
          ...
          <li>
            <p className="py-4">
              ...
              n&apos;aime aucun des disques proposés par Jim. La rencontre peut
              se faire via la messagerie. Le disque est acheté au prix
              forfaitaire de 5 € (prix conseil Vinylemania). La transaction se
              fait dans la vraie vie, en dehors de la plateforme, sous la seule
